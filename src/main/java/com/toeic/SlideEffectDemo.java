...
public class SlideEffectDemo extends Application {
    ...
    private void configureBox(VBox root) {
        ...
        bottomPane.getChildren().addAll(new Rectangle(200, 150, Color.DARKCYAN));
        ...
        sp1.getChildren().add(new Rectangle(200, 150, Color.BISQUE));

        topPane = new StackPane();
        topPane.getChildren().addAll(new Rectangle(200, 150, Color.RED));
...
// Animation for scroll down.
    ...
    private HBox getActionPane(){
        ...
        upBtn.setOnAction((EventHandler) event -> timelineUp.play());

        Button downBtn = new Button("Slide Down");
        downBtn.setOnAction((EventHandler) event -> timelineDown.play());
