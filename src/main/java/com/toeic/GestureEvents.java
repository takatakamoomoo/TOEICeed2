...
public class GestureEvents extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        // organize them
        StackPane shapes = new StackPane ();
        shapes.setAlignment(Pos.CENTER);
        shapes.setPadding(new Insets(15.0));
        //shapes.setSpacing(30.0);
        shapes.setPrefWidth(500);

        page1 = createRectangle(Color.RED);
        page2 = createRectangle(Color.GREEN);

        shapes.getChildren().addAll(page1 ,page2);
        Group group = new Group(shapes);
        AnchorPane.setTopAnchor(group, 15.0);
    ...
    private Rectangle createRectangle(Color color) {
        ...
        final Rectangle rect = new Rectangle(100, 100, 300, 300);
        rect.setFill(color);
...
//        });
     ...
     *
     */
    private Rectangle createEllipse() {

        final Rectangle oval = new Rectangle(100, 100,300, 300);
